...
class WorktimeRessource(models.Model):
    ...
    created = models.DateTimeField("Created", auto_now_add=True)
    last_modified = models.DateTimeField("Last Modified", auto_now=True)
    time_elasped = models.FloatField("Work time (seconds)", default=0.)
    time_planned = models.FloatField("Time planned (seconds)", default=600.)
...
class Event(models.Model):
    ...
    start = models.DateTimeField("Start time", auto_now_add=True)
    stop = models.DateTimeField("Stop time", auto_now_add=True)
