...
import skii.platform.entities
import skii.platform.models.common
import skii.platform.models.user
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.CharField(default="", max_length=80, verbose_name="Label"),
                ),
                (
                    "value_currency",
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        ...
                        default=Decimal("0"),
                        max_digits=20,
                        verbose_name="Time delta in seconds",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "picture",
                    models.ImageField(
                        default=skii.platform.entities.get_default_cover_image,
                        upload_to="",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "album",
                    models.ForeignKey(
                        default=skii.platform.models.common.get_default_album,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="items",
                        to="platform.visualalbum",
                        verbose_name="Album",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        related_name="events_linked",
                        to="platform.studentagent",
                    ),
                ),
                (
                    "teacher",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        to="platform.teacheragent",
                    ),
                ),
            ],
            options={
                "verbose_name": "Lesson",
                "verbose_name_plural": "Lesson(s)",
        ...
        migrations.CreateModel(
            ...
            options={
                "verbose_name": "Skii platform user",
                "verbose_name_plural": "Skii platform user(s)s",
                "abstract": False,
                "swappable": "AUTH_USER_MODEL",
            },
            managers=[
                ("objects", skii.platform.models.user.UserSkiiManager()),
            ],
        ),
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("start__lt", models.F("stop")),
                    models.Q(
                        ("start__range", (models.F("start"), models.F("stop"))),
                        _negated=True,
                    ),
                    models.Q(
                        ("stop__range", (models.F("start"), models.F("stop"))),
                        _negated=True,
                    ),
                ),
